...
sqs_queue_arn = "arn:aws:sqs:us-east-1:123456789012:my-project-staging-processor"

# S3 — output this_s3_bucket_arn from s3-bucket-stack
s3_bucket_arn = "arn:aws:s3:::my-project-staging-data"
...
lambda_env_vars = {
  ...
  # DB_HOST      = "my-project-staging.cluster.us-east-1.rds.amazonaws.com"
  # FEATURE_FLAG = "true"
}
